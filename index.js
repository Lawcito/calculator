...
//Se fija si es el primer número o el segundo el que se está escribiendo.
  ...
  e.addEventListener("click", () => {
    ...
    if (e.textContent != "=") {
      if (operacion == undefined) {
        ...
        //LLama a las funciones para que se ejecuten respectivamente.
        switch (operacion) {
          case "+":
      ...
      secondNum = parseInt(secondNum.join(""));
      //LLama a las funciones nuevamente.
      switch (operacion) {
        case "+":
          subTotal = sumar(firstNum, secondNum);
